...
import WeeklyPlan from "@/features/menu-plan/ui/WeeklyPlan";
import ShoppingListCard from "@/features/shopping-list/ui/ShoppingListCard";
                ...
                <div className="d-grid gap-3">
                    {actions.map((action, index) => (
                        <button
                            ...
                            onMouseEnter={(e) =>
                                (e.currentTarget.style.backgroundColor = `rgba(${hexToRgb(
                                    action.color
                                )}, 0.15)`)
                            }
                            onMouseLeave={(e) =>
