      ...
      <div className="row mb-4">
        ...
        <div className="col-md-6">
          <Card className="h-100">
            ...
            <Card.Body>
              <p className="text-muted">
                Всего ингредиентов: {ingredients.length} | Аллергенов:{" "}
            ...
            <div className="row">
              <div className="col-md-6">
                <Form.Group className="mb-3">
                  ...
                  />
                  <Form.Text className="text-muted">Время в минутах</Form.Text>
                </Form.Group>
              </div>
              <div className="col-md-6">
                <Form.Group className="mb-3">
        ...
        <Modal.Body>
          <Form>
            ...
            <div className="alert alert-info">
              <small>
                <strong>Примечание:</strong> После добавления ингредиента вы
                сможете использовать его при создании блюд.
              </small>
            </div>
          </Form>
        </Modal.Body>
