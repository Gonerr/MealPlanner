            ...
            <Modal.Body className="p-0" style={{ backgroundColor: "#ffffff" }}>
                <div className="d-flex" style={{ minHeight: "600px" }}>
                    ...
                    <div className="flex-shrink-0" style={{ width: "40%" }}>
                        <div
                            ...
                            style={{
                                ...
                                backgroundImage: `url(${
                                    dish.imageUrl || "/placeholder-recipe.jpg"
                                })`,
                    ...
                    >
                        ...
                        >
                            <h5 className="h6 fw-semibold mb-2">
                                👨‍🍳 Советы шефа
                            </h5>
                            <p className="text-gray-600 mb-0 small">
                                Для лучшего вкуса дайте салату настояться 10-15
                                минут перед подачей. Свежая зелень добавляется в
                                последний момент для сохранения аромата.
                            </p>
                        </div>
                    </div>
                </div>
