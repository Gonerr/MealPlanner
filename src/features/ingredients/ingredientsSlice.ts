    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchIngredients.rejected, (state, action) => {
                state.loading = true;
                state.error =
                    action.error.message || "Failed to fetch ingredients";
            });
...
export const selectAllIngredients = (state: { ingredients: IngredientState }) =>
...
export const selectIngredientById =
    (id: number) => (state: { ingredients: Ingredient[] }) =>
